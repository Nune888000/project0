...
Заинтересованность
                        ...
                        /                          \
    Значительное +-----------------------------------+  
      влияние    |          Удовлетворять           |  Активно принимать участие
                 |          (Инвесторы)             |  (Руководитель проекта, Команда разработчиков, Заказчик)
                 |                                  |
                 |----------------------------------|-----------------------------------+ Влияние
                 |         Наблюдать                |           Держать в курсе         |
                 |         (Тестировщики)           |           (Конечные пользователи) |
    Незначительное+---------------------------------+-----------------------------------+
                         Несущественная заинтересованность
